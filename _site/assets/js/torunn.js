...
Array.from(circularProgress).forEach((progressBar) => {
 ...
 $(".carousel-item__button--see-similar").click(function() {
  ...
  function animateProgress01(diff) {
      ...
      $(".personality-01").animate({'z-index': toValue}, 1);
  }
  function animateProgress02(diff) { var currValue = $(".playback-bubble-02").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-02").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-02").animate({'z-index': toValue}, 1); }
  function animateProgress03(diff) { var currValue = $(".playback-bubble-03").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-03").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-03").animate({'z-index': toValue}, 1); }
  function animateProgress04(diff) { var currValue = $(".playback-bubble-04").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-04").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-04").animate({'z-index': toValue}, 1); }
  function animateProgress05(diff) { var currValue = $(".playback-bubble-05").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-05").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-05").animate({'z-index': toValue}, 1); }
  function animateProgress06(diff) { var currValue = $(".playback-bubble-06").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-06").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-06").animate({'z-index': toValue}, 1); }
  function animateProgress07(diff) { var currValue = $(".playback-bubble-07").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-07").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-07").animate({'z-index': toValue}, 1); }
  function animateProgress08(diff) { var currValue = $(".playback-bubble-08").width(); var toValue = currValue + diff; toValue = toValue < 0 ? 0 : toValue; toValue = toValue > 200 ? 200 : toValue; $(".playback-bubble-08").animate({'width': toValue}, 500).animate({'height': toValue}, 500); $(".personality-08").animate({'z-index': toValue}, 1); }
  ...
  $(".thumbs-up.style-shuffle-rating-01, .item-drilldown__item-01").click(function() { $(".playback-bubble-01").show();});
  $(".thumbs-up.style-shuffle-rating-02, .item-drilldown__item-02").click(function() { $(".playback-bubble-02").show();});
  $(".thumbs-up.style-shuffle-rating-03, .item-drilldown__item-03").click(function() { $(".playback-bubble-03").show();});
  $(".thumbs-up.style-shuffle-rating-04, .item-drilldown__item-04").click(function() { $(".playback-bubble-04").show();});
  $(".thumbs-up.style-shuffle-rating-05, .item-drilldown__item-05").click(function() { $(".playback-bubble-05").show();});
  $(".thumbs-up.style-shuffle-rating-06, .item-drilldown__item-06").click(function() { $(".playback-bubble-06").show();});
  $(".thumbs-up.style-shuffle-rating-07, .item-drilldown__item-07").click(function() { $(".playback-bubble-07").show();});
  $(".thumbs-up.style-shuffle-rating-08, .item-drilldown__item-08").click(function() { $(".playback-bubble-08").show();});
  $(".thumbs-up.style-shuffle-rating-09, .item-drilldown__item-09").click(function() { $(".playback-bubble-09").show();});
